...
function TransportModes() {
    ...
    const handleChange = (event) => {
        stateValues.setAppState((prevState) => ({ ...prevState, transportation_mode: event.target.value }));
    };
    ...
    return (
        <div className='radio_sheets'>
            <RadioGroup
                ...
                value={stateValues.appState.transportation_mode} // Set the value of the RadioGroup to the selectedValue
